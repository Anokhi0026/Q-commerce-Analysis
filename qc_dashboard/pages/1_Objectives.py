...
for tag, icon, title, desc, methods, color in objs:
    st.markdown(f"""
      ...
      <div style='flex:1;'>
        <div style='display:flex;align-items:center;gap:8px;margin-bottom:4px;'>
          <span style='font-size:.7rem;font-weight:700;color:{color};text-transform:uppercase;
                       letter-spacing:.1em;background:{color}15;padding:2px 8px;border-radius:20px;'>{tag}</span>
          <span style='font-size:.95rem;font-weight:700;color:#1E1E2E;'>{title}</span>
        </div>
